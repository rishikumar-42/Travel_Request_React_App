...
const FormPreview = ({ item, travelInfo, attachments }) => {
  ...
  const formatDateTime = (date) => {
    ...
    const dateString = new Intl.DateTimeFormat("en-GB", dateOption)
      .format(new Date(date))
      ?.replaceAll(" ", "-");
    const timeString = new Intl.DateTimeFormat("en-GB", timeOption).format(
      new Date(date)
    );
      ...
      <div className="preview-summary-content">
          ...
          <div className="preview-details-grid">
            ...
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.issuerDate !== null ? formatDate(item.issuerDate) : "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              <span className="preview-label">Telephone Number:</span>
              <span className="preview-value">
                {item.issuerNumber || "N/A"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="preview-summary-details">
          <div className="preview-details-grid">
            ...
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.hotelCheckIn !== null
                  ? formatDateTime(item.hotelCheckIn)
                  : "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.hotelCheckOut !== null
                  ? formatDateTime(item.hotelCheckOut)
                  : "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
        ...
        <div className="preview-summary-details">
          <div className="preview-details-grid">
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.carRentalCategory || "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              <span className="preview-label">From:</span>
              <span className="preview-value">
                {item.carRentalFrom || "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
            ...
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.carRentalOn instanceof Date && !isNaN(item.carRentalOn)
                  ? formatDate(item.carRentalOn)
                  : "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.carRentalUntil instanceof Date &&
                !isNaN(item.carRentalUntil)
                  ? formatDate(item.carRentalUntil)
                  : "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.carDrivingLicense || "N/A"}
              </span>
            </div>
            <div className="preview-detail-item">
              <span className="preview-label">Remarks:</span>
              <span className="preview-value">
                {item.carRentalNote || "N/A"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="preview-summary-details">
          <div className="preview-details-grid">
            <div className="preview-detail-item">
              ...
              <span className="preview-value">
                {item.flightTicketType !== null &&
                item.flightTicketType !== undefined
                  ? typeof item.flightTicketType === "object"
                    ? item.flightTicketType.name
                    : item.flightTicketType
                  : "N/A"}
              </span>
            </div>
            <div className="detail-item preview-train-type">
              ...
              <span className="preview-value">
                {" "}
                {item.trainTicketType && item.trainTicketType !== undefined
                  ? typeof item.trainTicketType === "object"
                    ? item.trainTicketType.name
                    : item.trainTicketType
                  : "N/A"}
              </span>
            </div>
            {/* <div className="preview-detail-item">
        ...
        <div className="summary-details">
          <div className="detail-item">
            ...
            <span className="preview-value">
              {" "}
              {item.flightTicketReason && item.flightTicketReason !== undefined
                ? typeof item.flightTicketReason === "object"
                  ? item.flightTicketReason.name
                  : item.flightTicketReason
                : "N/A"}
            </span>
          </div>
        </div>
